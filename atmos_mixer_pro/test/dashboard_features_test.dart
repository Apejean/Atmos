...
void main() {
  testWidgets('TrackCard dropdown parses output properly', (
    ...
    final config = AppConfig(oscWhitelist: const [], 
      ...
      monoConfigs: {
        1: ChannelSetting(enabled: true, customName: 'Mono1', delayMs: 0.0, eqBands: [], gainDb: 0.0, phaseInvert: false),
        2: ChannelSetting(enabled: true, customName: 'Mono2', delayMs: 0.0, eqBands: [], gainDb: 0.0, phaseInvert: false),
      },
      stereoConfigs: {
        3: ChannelSetting(enabled: true, customName: 'Stereo3', delayMs: 0.0, eqBands: [], gainDb: 0.0, phaseInvert: false),
      },
      multiConfigs: {},
      rooms: [],

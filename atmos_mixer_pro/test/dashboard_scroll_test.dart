...
void main() {
  testWidgets('PointerScrollEvent on nested vertical ListView inside horizontal ListView', (WidgetTester tester) async {
              ...
              if (pointerSignal is PointerScrollEvent) {
                GestureBinding.instance.pointerSignalResolver.register(pointerSignal, (PointerSignalEvent event) {
                  ...
                  if (event is PointerScrollEvent) {
                    horizontalController.jumpTo(horizontalController.offset + event.scrollDelta.dy);
                  }
                });
              }
            },
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: 20,
                  itemBuilder: (context, vIndex) => Container(height: 50, color: Colors.red),
                ),
              ),
            ),
          ),

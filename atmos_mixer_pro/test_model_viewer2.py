...
# Replace the Top-Left Room Badge to match the screenshot EXACTLY.
old_badge = """          // 2. Top-Left Room Setup & Info Badge
          Positioned(
            top: 16,
            left: 16,
            child: Row(
...
new_badge = """          // 2. Top-Left Floating Info Badge (from screenshot)
          Positioned(
            top: 24,
            left: 24,
            child: Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Icon(Icons.view_in_ar_rounded, size: 18, color: Colors.lightBlueAccent),

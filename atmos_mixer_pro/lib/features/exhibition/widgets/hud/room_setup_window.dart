            ...
            child: Column(
              ...
              children: [
                ...
                _StepperInputRow(
                  ...
                  label: 'Width:',
                  value: width,
                  onChanged: (val) => setState(() => width = val < 1.0 ? 1.0 : val),
                  step: 0.5,
                ),
                ...
                _StepperInputRow(
                  ...
                  label: 'Depth:',
                  value: depth,
                  onChanged: (val) => setState(() => depth = val < 1.0 ? 1.0 : val),
                  step: 0.5,
                ),
                const SizedBox(height: 10),
                _StepperInputRow(
                  ...
                  value: ceilingHeight,
                  onChanged: (val) => setState(() => ceilingHeight = val < 1.0 ? 1.0 : val),
                  step: 0.1,
                ),
                const SizedBox(height: 10),
                _StepperInputRow(
                  ...
                  label: 'Ear Level:',
                  value: earLevel,
                  onChanged: (val) => setState(() => earLevel = val < 0.1 ? 0.1 : val),
                  step: 0.1,
                ),

...
bad_badge = """          // 2. Top-Left Room & Viewport Info Badge
          Positioned(
            top: 16,
            left: 16,
            child: Container(
...
good_badge = """          // 2. Top-Left Room Setup & Info Badge
          Positioned(
            top: 16,
            left: 16,
            child: Row(
...
content = content.replace(bad_badge, good_badge)

bottom_setup_btn = """          // 3. Bottom-Left Room Setup Button
          Positioned(
            bottom: 24,
            left: 24,
...
content = content.replace(bottom_setup_btn, "")

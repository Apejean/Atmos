...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2143760714;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__simple__api_play_track_impl(port, ptr, rust_vec_len, data_len),
        12 => {
            wire__crate__api__simple__api_preload_all_sounds_impl(port, ptr, rust_vec_len, data_len)
        }
        13 => wire__crate__api__simple__api_save_config_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__simple__api_set_active_room_impl(port, ptr, rust_vec_len, data_len),
        15 => {
        ...
        20 => wire__crate__api__simple__api_stop_all_impl(port, ptr, rust_vec_len, data_len),
        21 => {
            wire__crate__api__simple__api_stop_audio_engine_impl(port, ptr, rust_vec_len, data_len)
        }
        22 => wire__crate__api__simple__api_stop_track_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}

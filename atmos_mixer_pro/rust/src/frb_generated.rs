...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1750229916;
...
fn wire__crate__api__simple__api_save_scene_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, crate::api::error::AtmosError>((move || {
                    let output_ok = crate::api::simple::api_save_scene(api_scene_id, api_name)?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__simple__api_start_scheduler_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "api_start_scheduler",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, crate::api::error::AtmosError>((move || {
                    let output_ok = crate::api::simple::api_start_scheduler()?;
                    Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        15 => wire__crate__api__simple__api_get_audio_file_channels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__simple__api_get_config_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__simple__api_get_device_channel_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__simple__api_get_device_channel_names_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        22 => wire__crate__api__simple__api_init_app_impl(port, ptr, rust_vec_len, data_len),
        23 => {
            wire__crate__api__simple__api_init_audio_system_impl(port, ptr, rust_vec_len, data_len)
        }
        24 => wire__crate__api__simple__api_is_engine_ready_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__simple__api_load_preset_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__simple__api_open_asio_panel_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__simple__api_play_all_loop_tracks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__simple__api_play_test_noise_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__simple__api_play_track_impl(port, ptr, rust_vec_len, data_len),
        30 => {
            wire__crate__api__simple__api_preload_all_sounds_impl(port, ptr, rust_vec_len, data_len)
        }
        31 => wire__crate__api__simple__api_preload_sound_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__simple__api_save_config_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__simple__api_save_scene_impl(port, ptr, rust_vec_len, data_len),
        ...
        43 => wire__crate__api__simple__api_start_scheduler_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__simple__api_stop_all_impl(port, ptr, rust_vec_len, data_len),
        45 => {
            wire__crate__api__simple__api_stop_audio_engine_impl(port, ptr, rust_vec_len, data_len)
        }
        46 => wire__crate__api__simple__api_stop_track_impl(port, ptr, rust_vec_len, data_len),
        47 => {
            wire__crate__api__simple__api_trigger_test_error_impl(port, ptr, rust_vec_len, data_len)
        }
        48 => wire__crate__api__simple__api_update_single_band_eq_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        49 => wire__crate__api__simple__api_update_sound_source_position_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__simple__api_update_spatial_config_json_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
